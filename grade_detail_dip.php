...
foreach($users as $user){
    ...
    $user->cpccbc5001b=convert_grade_without_td($user->cpccbc5001b,$user->userid,2533,"W",2548,"S");
    $user->cpccbc5010b=convert_grade_without_td($user->cpccbc5010b,$user->userid,2539,"W",2624,"S");
    $user->cpccbc5003a=convert_grade_without_td($user->cpccbc5003a,$user->userid,2538,"W",2702,"S");
    $user->cpccbc5002a=convert_grade_without_td($user->cpccbc5002a,$user->userid,2537,"W",2574,"S");
    $user->cpccbc5011a=convert_grade_without_td($user->cpccbc5011a,$user->userid,2658,"W",2659,"S");
    $user->cpccbc5018a=convert_grade_without_td($user->cpccbc5018a,$user->userid,2622,"W",2623,"S");
    $user->cpccbc5005a=convert_grade_without_td($user->cpccbc5005a,$user->userid,2558,"W",2559,"S");
    $user->cpccbc5004a=convert_grade_without_td($user->cpccbc5004a,$user->userid,2555,"W",2556,"S");
    $user->bsbpmg508a=convert_grade_without_td($user->bsbpmg508a,$user->userid,2713,"W",2856,"S");
    $user->bsbpmg505a=convert_grade_without_td($user->bsbpmg505a,$user->userid,2707,"W",2708,"S");
    $user->bsbohs504b=convert_grade_without_td($user->bsbohs504b,$user->userid,2710,"W",2711,"S");
