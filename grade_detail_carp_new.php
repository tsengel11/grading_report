...
//$PAGE->requires->js('https://unpkg.com/bootstrap-table@1.18.3/dist/bootstrap-table.min.js',true);
//$PAGE->requires->js('https://unpkg.com/bootstrap-table@1.18.3/dist/extensions/fixed-columns/bootstrap-table-fixed-columns.min.js',true);
...
$users_new=get_userlist_carp($selected_groupid);
...
//print_object($users_new);


$templatecontext = (object)[
    'texttodisplay'=>'Certificate III in Carpentry',
    'users'=>array_values($users),
    'users_new'=>array_values($users_new),
